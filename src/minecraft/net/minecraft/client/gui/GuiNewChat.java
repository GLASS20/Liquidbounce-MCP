...
public class GuiNewChat extends Gui {
	...
	private void setChatLine(IChatComponent chatComponent, int chatLineId, int updateCounter, boolean displayOnly) {
		...
		List<IChatComponent> list = GuiUtilRenderComponents.splitText(chatComponent, i, font, false, false);
					...
					if (i1 >= 0 && i1 < this.drawnChatLines.size()) {
						...
						for (IChatComponent ichatcomponent : chatline.getChatComponent()) {
							if (ichatcomponent instanceof ChatComponentText) {
								j1 += font.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText) ichatcomponent).getChatComponentText_TextValue(), false));
