...
public class GuiIngameMenu extends GuiScreen {
	...
	public void initGui() {
		...
		GuiButton china = new GuiButton(1337, this.width / 2 - 100, this.height / 4 + 128, "Reconnect");
		china.enabled = !this.mc.isIntegratedServerRunning();
		this.buttonList.add(china);
